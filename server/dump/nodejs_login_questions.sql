...
('Care dintre următoarele structuri este localizată distal de uretra prostatică?', '["Uretra membranoasă", "Colul vezical", "Ductele ejaculatorii", "Zona tranzițională a prostatei", "Ligamentele puboprostatice"]', '1', 'Urologie', 5, 'Uretra membranoasă, care este împrejmuită de sfincterul urinar extern, este localizată distal de uretra prostatică.'),
('Ce procent din volumul ejaculatului este reprezentat de secrețiile glandei prostatice?', '["5%", "10%", "15%", "20%", "25%"]', '4', 'Urologie', 3, 'Secrețiile glandei prostatice reprezintă aproximativ 20% din volumul ejaculatului normal, oferind substanțe nutritive necesare pentru motilitatea și funcția normală a spermatozoizilor.'),
...
('Ce complicație este frecventă în cazul netratării prostatitei acute?', '["Insuficiență renală", "Abces prostatic", "Fistulă vezico-rectală", "Sepsis", "Hipotensiune arterială"]', '2, 4', 'Urologie', 5, 'Prostatita acută netratată poate duce la formarea unui abces prostatic și la sepsis.'),
('Ce test imagistic este cel mai sensibil pentru detectarea metastazelor osoase în cancerul de prostată?', '["Radiografia simplă", "CT abdominal", "Scintigrafia osoasă", "RMN pelvian", "Ecografia abdominală"]', '3', 'Urologie', 4, 'Scintigrafia osoasă este cea mai sensibilă metodă pentru detectarea metastazelor osoase în cancerul de prostată.'),
...
('Care dintre următoarele simptome indică o obstrucție urinară inferioară în HBP?', '["Jet urinar slab", "Nicturie", "Hematurie", "Polakiurie", "Febră"]', '1, 2, 4', 'Urologie', 3, 'Jetul urinar slab, nicturia și polakiuria sunt simptome clasice ale obstrucției urinare inferioare în HBP. Hematuria și febra nu sunt simptome tipice.'),
('Ce factor de risc major este asociat cu cancerul de prostată?', '["Vârsta înaintată", "Istoric familial de cancer de prostată", "Dieta săracă în grăsimi", "Fumatul", "Infecțiile urinare recurente"]', '1, 2', 'Urologie', 3, 'Vârsta înaintată și istoricul familial sunt cei mai importanți factori de risc pentru cancerul de prostată. Dieta, fumatul și infecțiile urinare nu au o legătură clară.'),
...
('Ce simptom este cel mai frecvent întâlnit în prostatita cronică?', '["Dureri perineale", "Hematurie", "Febră", "Jet urinar slab", "Scăderea în greutate"]', '1', 'Urologie', 3, 'Durerile perineale sunt cele mai frecvente simptome ale prostatitei cronice. Hematuria, febra și scăderea în greutate nu sunt simptome tipice.'),
